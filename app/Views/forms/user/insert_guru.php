                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="card">
                                ...
                                <form action="<?= base_url('/home/action_add_teacher_data') ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <!-- NIK -->
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="input-icon">
                                                            ...
                                                            <input type="text" name="nik_input" id="nik_input" placeholder="nik" class="form-control" maxlength="20" required>
